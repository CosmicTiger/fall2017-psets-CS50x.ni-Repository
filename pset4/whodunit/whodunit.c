...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0, biHeight = abs(bi.biHeight); i < biHeight; i++)
    {
        ...
        for (int j = 0; j < bi.biWidth; j++)
        {
            ...
            // we confirm the specific values in which the struct RGBTRIPLE set the red color on the BMP of clue
            ...
            {
                // and then we proceed on changing the values to unveil our culprit
